  ...
  return (
    <div className="fixed inset-0 z-0 overflow-hidden bg-gradient-to-b from-slate-950 via-indigo-950 to-orange-950 pointer-events-none">
      ...
      >
        ...
        <div 
          className="absolute bottom-0 w-[120%] -left-[10%] h-[65vh] min-h-[650px] sm:bottom-100 sm:w-[120%] sm:-left-[10%] sm:h-[80vh] sm:min-h-[700px] md:bottom-70 md:w-[500%] md:left-[200%] md:h-[60vh] md:min-h-[600px] lg:bottom-0 lg:w-[120%] lg:left-[-10%] lg:h-[40vh] lg:min-h-[570px]"
        >
          <svg 
